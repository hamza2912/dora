    ...
    return (
      ...
      <div className='w-full h-auto'>
          <div className='flex flex-col lg:w-1/3 w-full px-5 lg:px-0 mx-auto items-center pt-24 pb-16'>
                <h1 data-aos="fade-up" className='font-semibold lg:text-4xl text-2xl tracking-wide'>Join the waitlist</h1>
                <p className='text-xl mt-5'>Get notified when we launch.</p>
                <div className='w-full grid grid-cols-3 gap-2 mt-8'>
                    <input value={email} onChange={(event) => setemail(event.target.val)} className='col-span-2 bg-gray px-4 py-2 rounded-md input-border focus:outline-none' placeholder='Email address' type="email" />
                    <button onClick={()=>{setshowModal(true)}} className='bg-brown text-white rounded-md text-sm'>Join the wallet</button>
                </div>
                <div className='w-1/2 grid grid-cols-3 gap-4 place-items-center mt-24'>
                    <a data-aos="zoom-in" data-aos-delay="100" className={isHoverInsta ? 'flex justify-center items-center rounded-full bg-insta w-10 h-10 transition-all' : 'flex justify-center items-center rounded-full bg-gray w-10 h-10 transition-all'} href="" target="_blank"
                    ...
                    <a data-aos="zoom-in" data-aos-delay="200" className={isHoverfb ? 'flex justify-center items-center rounded-full bg-fb w-10 h-10 transition-all' : 'flex justify-center items-center rounded-full bg-gray w-10 h-10 transition-all'} href="" target="_blank"
                    ...
                    onMouseOut={()=>setisHoverfb(false)}><svg width="12" height="19" viewBox="0 0 12 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <a data-aos="zoom-in" data-aos-delay="300" className={isHovertwitter ? 'flex justify-center items-center rounded-full bg-twitter w-10 h-10 transition-all' : 'flex justify-center items-center rounded-full bg-gray w-10 h-10 transition-all'} href="" target="_blank"
                ...
                <h1 className='font-semibold lg:text-2xl text-2xl tracking-wide mt-20'>we are <span className='text-transparent bg-clip-text hero-text'>latina founded</span></h1>
          </div>
          {
            showModal ?    
                <div>
